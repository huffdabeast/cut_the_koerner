...
const Sidebar = () => {
  ...
  return (
    <>
      <nav className="fixed top-0 left-0 w-full h-full border-r bg-[#030303] space-y-8 sm:w-80">
          ...
          <div className="h-20 flex items-center pl-2">
            <div className="w-full flex items-center gap-x-4">
              ...
              <div>
                ...
                <span className="block mt-px text-gray-400 text-xs">Hobby Plan</span>
              </div>

              <div className="relative flex-1 text-right">
                <button
                  ref={profileRef}
                  className="p-1.5 rounded-md text-gray-400 hover:bg-gray-700 active:bg-gray-600"
                ...
                {isProfileActive && (
                  <div
                    id="profile-menu"
                    role="menu"
                    className="absolute z-10 top-12 right-0 w-64 rounded-lg bg-[#030303] shadow-md border border-gray-700 text-sm text-gray-400"
                  >
                    <div className="p-2 text-left">
                      <span className="block text-gray-400/80 p-2">alivika@gmail.com</span>
                      <a
                        href="javascript:void(0)"
                        className="block w-full p-2 text-left rounded-md hover:bg-gray-700 active:bg-gray-600 duration-150"
                        role="menuitem"
                      >
                        Add another account
                      </a>

                      <div className="relative rounded-md hover:bg-gray-700 active:bg-gray-600 duration-150">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 20 20"
                          fill="currentColor"
                        ...
                        <select className="w-full cursor-pointer appearance-none bg-transparent p-2 outline-none text-white" defaultValue="">
                      ...
                      <button className="block w-full p-2 text-left rounded-md hover:bg-gray-700 active:bg-gray-600 duration-150">
                        Logout
                      </button>
                    </div>
                  </div>
            ...
            <ul className="text-sm font-medium flex-1">
              {navigation.map((item, idx) => (
                <li key={idx}>
                  <a
                    href={item.href}
                    className="flex items-center gap-x-2 text-gray-400 p-2 rounded-lg hover:bg-gray-700 active:bg-gray-600 duration-150"
                  >
